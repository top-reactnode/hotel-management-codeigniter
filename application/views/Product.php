									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										<thead>
											<tr>
												...
												<th>รายละเอียดการรับของ</th>
												<th>รายละเอียดการเบิกสินค้า</th>
												<th>อัพเดดข้อมูล</th>
											</tr>
										</thead>
										<tbody>
										<!-- <?php if($leaving != null)
															...
															<td><div class='text-center'><a class='btn btn-success' href='<?php echo base_url('index.php/ProductUpdate_controller?empid='.$row["EMP_ID"])?>'>
															<i class='icon-cog '></i> Update</a></div> </td>
														 <?php endforeach ?> -->
										</tbody>
									</table>
									<p>
									<a href="<?php echo base_url('index.php/ProductAdd_controller')?>"><button class="btn btn-success"><i class="icon-plus icon-white"></i> Add_Product</button></a>
								</p>
								</div>
							</div>
						</div>
